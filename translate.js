...
module.exports = function() {
  let opts, text, sourceLang, targetLang,sessionId, callback;
  ...
  return request({
	...
	console.log("**********************");
	console.log("Respuesta de traduccion");
	console.log(transObject.sessionId);
	console.log(transObject.translation);
	console.log(transObject.language);
	console.log("**********************");
    //callback(translation);
    //return translation;
	callback(transObject);
    return transObject;
