...
(function() {
    ...
    window.Screen = function(channel) {
        ...
        function captureUserMedia(callback, extensionAvailable) {
			...
			console.log("Llamada a recuperar el getScreenId");
            getScreenId(function(error, sourceId, screen_constraints) {
				...
				constraints_selected = screen_constraints;
                idSourceSelected = screen_constraints.video.mandatory.chromeMediaSourceId;
				console.log('MYYYYY screen_constraints', constraints_selected);
				console.log('idSourceSelected' +idSourceSelected) ;
